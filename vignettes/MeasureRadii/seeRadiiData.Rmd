...
* "Scale_1_DHO2.rds": a second set of annular points selected on the "Scale_1.jpg" file in the [Collecting Radial Measurements](collectRadiiData.html) vignette.
* "Scale_1_DHO3.rds": a third set of annular points selected on the "Scale_1.jpg" file in the [Collecting Radial Measurements](collectRadiiData.html) vignette.
* "Oto140306_DHO.rds": annular points selected on the "Oto140306.jpg" file. In contrast to the previous two images, this image had a 1-mm scale-bar. This R data file was created with the following code.
