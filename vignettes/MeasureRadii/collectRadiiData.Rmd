...
* `description=`: Detailed description about the structure. This will be saved in the RData file and could be extracted in the future. For example, one may use `description="Kiyi scale read once by Ogle on 22-Apr-18"` to provide more information about the structure reading.
