...
* `windowSize=`: A value that sets the size of the separate window. This value will become the larger of the two dimensions, with the other value proportionate so that the original aspect ratio of the image is maintained. Use `windowSize=` to "zoom in" on an image. Note that the default is `windowSize=7`; so values larger than 7 represent a "zooming in."
